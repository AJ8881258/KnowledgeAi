...
public class OpenAiCompatibleChatModelClient implements ChatModelClient {
    ...
    public String chat(Long userId, String prompt, double temperature) {
        EffectiveModelConfig config = resolveConfig(userId);
        try {
     ...
     */
    private EffectiveModelConfig resolveConfig(Long userId) {
     ...
     */
    private EffectiveModelConfig fromEnvironment() {
