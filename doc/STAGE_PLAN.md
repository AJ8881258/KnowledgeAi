...
| 阶段 11：文档处理增强 | 下一阶段 | OCR、更多文件格式、后台处理队列和失败重试 |
...
阶段 10 已完成。下一步进入阶段 11：文档处理增强，优先评估 Word、PPT、Excel、HTML、更多 PDF 场景和 OCR 是否进入当前 MVP；如涉及新文档处理接口或状态流转，必须先同步 `doc/API.md`。
